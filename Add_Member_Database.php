...
if($sucess){
	...
	if($mail->Send()){
		...
		alert("Your registration succeed! Please receive the validation email to activate your account.");
		...
		alert(" There is a problem in sending validation email , please try it later.");
