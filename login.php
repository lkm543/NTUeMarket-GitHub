  ...
  <div class="row">
    <div class="col-md-3 col-md-offset-2" style="margin-top:80px;">
      ...
      <form action="login_check.php" method="post" name="registration" >
        ...
        <button type="submit" class="btn btn-default">登入</button><a href="fbconfig.php"><img src="images/fbsignin.png" style="padding-left:30px" width="80%"></a>
      </form>
    </div>
    <div class="col-md-5">
      <div style="padding-left:15%;margin-left:10%;border:3px;border-left-style:dotted;">
        <center><p style="font-size:20px;">新用戶註冊</p></center>
