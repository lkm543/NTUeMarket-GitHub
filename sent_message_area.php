...
$sql = "select m.username as receiver, m.active, msg.* from member m, message msg where m.id = msg.to and msg.from='$user_ID' and `sender_status`=1 order by msg.id desc";
