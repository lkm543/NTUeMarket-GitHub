...
if (isset($_SESSION['MM_Username'])){?>
  <p align="left" style="font-size:24px;margin-top:80px;"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;商品上架成功!</strong></p>
      <div style="float:left;margin-right:20px;">
        <button type="button" class="btn btn-primary btn-lg" onclick="location.href='upload_area.php'">繼&nbsp;續&nbsp;&nbsp;上&nbsp;傳</button>
      </div>
      <div style="float:left">
        <button type="button" class="btn btn-success btn-lg" onclick="location.href='show_item.php'">至商品總覽</button>
      </div></div>
<?php }?>
